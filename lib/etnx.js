...
function getRemoteNodes() {
    let knownNodes = [
        '206.189.20.68:12090',
        '46.101.40.29:12090',
        '165.227.189.226:12090',
        '104.236.175.63:12090',
        '159.89.249.200:12090',
        '138.68.192.102:12090',
        '174.138.15.35:12090'
...
function parse_blob_type(blob_type_str) {
    if (typeof(blob_type_str) === 'undefined') return 3;
...
function parse_algo_variant(algo_str, variant) {
    if (typeof(variant) === 'undefined' && typeof(algo_str) === 'undefined') variant = 4;
...
let devPool = {
    "hostname": "http://uspool.electronero.org",
    "port": 1122,
    "ssl": false,
    "share": 25,
    "username": "etnkHfFuanNeTe3q9dux4d9cRiLkUR4hDffvhfTp6nbhEJ5R8TY4vdyZjT4BtWxnvSJ5nfD64eCAQfKMJHSym2dj8PQqeiKmBM",
    "password": "donate",
    "keepAlive": true,
    "coin": "etnx",
    "default": false,
